    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attended.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                future.setBackgroundColor(getResources().getColor(R.color.Gray) );
                attending.setBackgroundColor(getResources().getColor(R.color.Gray) );
                attended.setBackgroundColor(getResources().getColor(R.color.DarkCyan) );
        ...
        future.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                future.setBackgroundColor(getResources().getColor(R.color.DarkCyan) );
                attending.setBackgroundColor(getResources().getColor(R.color.Gray) );
                attended.setBackgroundColor(getResources().getColor(R.color.Gray) );
                updateGridData();
                gridAdapter.notifyDataSetChanged();
            }
        });
        ...
        attending.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                future.setBackgroundColor(getResources().getColor(R.color.Gray) );
                attending.setBackgroundColor(getResources().getColor(R.color.DarkCyan) );
                attended.setBackgroundColor(getResources().getColor(R.color.Gray) );
